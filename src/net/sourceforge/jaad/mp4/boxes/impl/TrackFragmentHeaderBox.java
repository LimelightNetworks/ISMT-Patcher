...
public class TrackFragmentHeaderBox extends FullBox {
	...
	public void decode(MP4InputStream in) throws IOException {
		...
		if (defaultSampleSizePresent) {
			defaultSampleSizeOffset = in.getOffset();
		...
		defaultBaseIsMoof = ((flags&0x20000)==0x20000);
		
		//System.out.println("TrackFragmentHeaderBox: " +
				//" trackID " + trackID + 
				//" baseDataOffsetPresent " + baseDataOffsetPresent + 
				//" baseDataOffset " + baseDataOffset + 
				//" sampleDescriptionIndexPresent " + sampleDescriptionIndexPresent + 
				//" sampleDescriptionIndex " + sampleDescriptionIndex + 
				//" defaultSampleDurationPresent " + defaultSampleDurationPresent + 
				//" defaultSampleDuration " + defaultSampleDuration + 
				//" defaultSampleSizePresent " + defaultSampleSizePresent +
				//" defaultSampleSize " + defaultSampleSize); 
				//" defaultSampleFlagsPresent " + defaultSampleFlagsPresent + 
	...
	public long getDefaultSampleSizeOffset() {
		return defaultSampleSizeOffset;
	}
	...
	public boolean isDefaultBaseMoof() {
