...
public class BoxFactory implements BoxTypes {
	...
	public static Box parseBox(Box parent, MP4InputStream in, int length) throws IOException {
		...
		if (box.type==BoxTypes.MEDIA_DATA_BOX && length > 0)
			((MediaDataBox) box).setLength(length);
		box.decode(in);
